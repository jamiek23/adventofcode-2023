...
PART_ONE = """7jlncfksix7rjgrpglmn9
...
def main():
    print(get_calibration_value(PART_ONE))

def get_calibration_value(doc: str) -> int:
    result = 0
    for line in doc.splitlines():
        digits = filter_for_numbers(line)
        num = int("".join([digits[0], digits[-1]]))
        result += num
    return result


def filter_for_numbers(value: str):
